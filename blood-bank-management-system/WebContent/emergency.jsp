...
<html>
 ...
 <body>
  ...
  <h3 class="t1">Emergency Blood Needed</h3>
</center>
<div id="result">
 <%
  ...
  try{
 	...
 	ResultSet rs=st.executeQuery("select * from post where dor>='2014-07-27'");
 	pw.println("<table colspan='1' border='1' width='690' id='table1'>");pw.println("<tr>");
 	pw.println("<th>");pw.println("bg");pw.println("</th>");
 	pw.println("<th>");pw.println("Phno");pw.println("</th>");
 	pw.println("<th>");pw.println("Address");pw.println("</th>");
 	pw.println("<th>");pw.println("purpose");pw.println("</th>");
 	pw.println("<th>");pw.println("date of requirement");pw.println("</th>");
 	pw.println("</tr>");
 while(rs.next())
 {
	 pw.println("<tr>");
